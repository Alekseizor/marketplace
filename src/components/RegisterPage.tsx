                ...
                <form className="mt-6">
                    <div className="mb-2">
                        ...
                        <input
                            ...
                            value={name}
                            className="block w-full px-4 py-2 mt-2 text-neutral-900 bg-white border rounded-md focus:border-indigo-400 focus:ring-fuchsia-700 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                    </div>
                    <div className="mb-2">
                        <label
